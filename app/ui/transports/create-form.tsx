...
import { createTransport } from '@/app/lib/actions/transports';

export default function Form() {
  const initialState = { message: null, errors: {} };
  const [state, dispatch] = useFormState(createTransport, initialState);
  ...
  return (
    <form action={dispatch}>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Dodaj transport</Button>
      </div>
    </form>
  );
}
