...
import { createOrganizer } from '@/app/lib/actions/organizers';
import type { ShirtsSizesList, ShirtsTypesList } from '@/app/lib/definitions';
...
export default function Form({
  ...
  const [state, dispatch] = useFormState(createOrganizer, initialState);
